                    ...
                    stage('windows_tests'){
                        ...
                        withCredentials([usernamePassword(credentialsId: params.credentialsId, passwordVariable: 'WordsClientSecret', usernameVariable: 'WordsClientId')]) {
                            try {
                                ...
                                bat (script: "docker build --cache-from=mcr.microsoft.com/windows/servercore:ltsc2016,${buildCacheImage}/wincore:latest -t ${buildCacheImage}/wincore:latest -t aspose-words-cloud-cpp-tests:wincore - < Dockerfile.wincore")
